        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edUsername.getText().toString()) || TextUtils.isEmpty(edFirstname.getText().toString()) || TextUtils.isEmpty(edSecondName.getText().toString()) || TextUtils.isEmpty(edPassword.getText().toString())) {
                    Toast.makeText(com.example.planshet.Sign_up.this, "Поля пустые", Toast.LENGTH_LONG).show();
                } else {
        ...
        registerResponseCall.enqueue(new Callback<RegisterResponse>() {
            ...
            public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(com.example.planshet.Sign_up.this, "Successful", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(com.example.planshet.Sign_up.this, SIgnIn.class));
                    finish();
                } else {
                    Toast.makeText(com.example.planshet.Sign_up.this, "Возникла ощибка, повторите позже...", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<RegisterResponse> call, Throwable t) {
                Toast.makeText(com.example.planshet.Sign_up.this, t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
